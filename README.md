...
- Итог — в stdout; у `scroll` stdout занят данными, поэтому его итог — в stderr. Ошибка — всегда в
...
| `bad_response` | 1 | ответ не по контракту: не JSON или `has_more` без курсора |
